...
public class TestNPC {
	...
	public void testStatsPorDificultad() {
		NonPlayableCharacter npc0 = new NonPlayableCharacter("Mica", 1, 0);
		NonPlayableCharacter npc1 = new NonPlayableCharacter("Mica", 1, 1);
		NonPlayableCharacter npc2 = new NonPlayableCharacter("Mica", 1, 2);
		NonPlayableCharacter npc3 = new NonPlayableCharacter("Mica", 1, 3);
	...
	public void testAtaque() {
		NonPlayableCharacter npc = new NonPlayableCharacter("Mica", 1, 0);
